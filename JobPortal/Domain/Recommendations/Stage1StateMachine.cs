...
{
    public class Stage1StateMachine : IStageStateMachine<Stage1TransitionContext>
    {
        ...
        public TransitionResult ApplyTransition(CandidateRecommendation rec, RecommendationStatus to, Stage1TransitionContext ctx)
        {
